    ...
    },
    {
      ...
      body: [
        ...
        ul(
          ...
          'systematic automated retrieval of the site or its content, including for the training of machine learning systems. We reserve text and data mining under § 44b (3) UrhG; our robots.txt states that reservation in machine-readable form',
        ),
    ...
    },
    {
      ...
      body: [
        ...
        ul(
          ...
          'das systematische automatisierte Auslesen der Seite oder ihrer Inhalte, auch zum Training maschineller Lernverfahren. Wir behalten uns die Nutzung für Text und Data Mining nach § 44b Abs. 3 UrhG vor; unsere robots.txt erklärt diesen Vorbehalt in maschinenlesbarer Form',
        ),
