...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    date: "2026-09-18",
    publishedAt: "2026-09-18T13:34:30Z",
    readTime: "4 min",
    image: "/images/news/moza-gamescom-porsche-ford-mercedes-wheels/1ijkexspzma-q65qoptkz8vlgx-e8a-nbz8wefgs-6mc-1.webp",
    imageAlt: "MOZA's First PS5 Wheels Bring Native Gran Turismo 7 Support, and the Mustang GTD Wheel Gets a Date",
    imageCredit: "MOZA Racing",
    author: "Lauren Hughes",
    topics: [
      { id: "sim-hardware", label: "Sim racing hardware" },
    ...
    translations: {
      de: {
        ...
        imageAlt: "MOZAs erste PS5-Lenkräder bringen native Gran Turismo 7-Unterstützung, und das Mustang-GTD-Lenkrad bekommt ein Datum",
        readTime: "4 min",
        content: [
          ...
          { kind: "p", text: "**MOZA** ist auf der Sim Gaming Expo 2026 (18.–20. September, im **Renaissance Schaumburg Convention** Center) mit dem Hands-on-Debüt des Mustang-GTD-Lenkrads und einer weiteren Premiere vertreten. **At Booth** 515 zeigte das Unternehmen erstmals das **HMA150 Motion System**: einen Motion-Rig für die Heimsimulation, aufgebaut um vier Aktuatoren mit je 150 mm Hub und einer Ansprechrate von bis zu 150 Hz, gesteuert über Echtzeit-Spieltelemetrie durch MOZA Motion Manager, um Beschleunigung, Bremsen, Kurvenfahrt und Streckenoberflächeneffekte nachzubilden." },
          { kind: "image", src: "/images/news/moza-gamescom-porsche-ford-mercedes-wheels/15ywfzzzby1mqla-jhk1wh6-8sex6i2jtwpslb7kctnk-4.webp", alt: "Hallenplan der Sim Gaming Expo 2026, MOZA at Booth 515", credit: "MOZA Racing" },
      ...
      es: {
        ...
        imageAlt: "Los primeros volantes de MOZA para PS5 traen soporte nativo para Gran Turismo 7, y el volante Mustang GTD ya tiene fecha",
        readTime: "5 min",
        content: [
          ...
          { kind: "p", text: "**MOZA** lo puso ante el público el **29 August** (29 de agosto) con un AI vs Human Racing Challenge en el stand: el embajador global de **MOZA**, **Dirk Schouten**, y el tricampeón mundial de F1 Esports **Jarno Opmeer** compitieron contra el AI Coach, transmitido en directo por el canal oficial de YouTube de **MOZA**." },
          ...
          { kind: "p", text: "**MOZA** está en la Sim Gaming Expo 2026 (18-20 de septiembre, en el **Renaissance Schaumburg Convention** Center) con el debut práctico del volante Mustang GTD y una primicia más. **At Booth** 515 la empresa mostró por primera vez el **HMA150 Motion System**: una plataforma de movimiento para simulación doméstica construida en torno a cuatro actuadores, cada uno con 150 mm de recorrido y una frecuencia de respuesta de hasta 150 Hz, controlada mediante telemetría de juego en tiempo real a través de MOZA Motion Manager para reproducir aceleración, frenada, curvas y efectos de la superficie de la pista." },
          { kind: "image", src: "/images/news/moza-gamescom-porsche-ford-mercedes-wheels/15ywfzzzby1mqla-jhk1wh6-8sex6i2jtwpslb7kctnk-4.webp", alt: "Plano de la Sim Gaming Expo 2026, con MOZA at Booth 515", credit: "MOZA Racing" },
      ...
      fr: {
        ...
        imageAlt: "Les premiers volants MOZA pour PS5 apportent une prise en charge native de Gran Turismo 7, et le volant Mustang GTD a enfin une date",
        readTime: "5 min",
        content: [
          ...
          { kind: "p", text: "**MOZA** l'a présenté au public le **29 August** (29 août) lors d'un AI vs Human Racing Challenge sur le stand : l'ambassadeur mondial de **MOZA**, **Dirk Schouten**, et le triple champion du monde de F1 Esports **Jarno Opmeer** ont couru contre l'AI Coach, retransmis en direct sur la chaîne YouTube officielle de **MOZA**." },
          ...
          { kind: "p", text: "**MOZA** est présent au Sim Gaming Expo 2026 (18-20 septembre, au **Renaissance Schaumburg Convention** Center) avec les débuts pratiques du volant Mustang GTD et une autre première mondiale. **At Booth** 515, l'entreprise a montré pour la première fois le **HMA150 Motion System** : une plateforme de mouvement pour simulation à domicile construite autour de quatre actionneurs, chacun avec 150 mm de course et une fréquence de réponse allant jusqu'à 150 Hz, pilotée par la télémétrie de jeu en temps réel via MOZA Motion Manager pour reproduire l'accélération, le freinage, les virages et les effets de surface de piste." },
          { kind: "image", src: "/images/news/moza-gamescom-porsche-ford-mercedes-wheels/15ywfzzzby1mqla-jhk1wh6-8sex6i2jtwpslb7kctnk-4.webp", alt: "Plan du salon Sim Gaming Expo 2026, montrant MOZA at Booth 515", credit: "MOZA Racing" },
      ...
      it: {
        ...
        imageAlt: "I primi volanti MOZA per PS5 portano il supporto nativo a Gran Turismo 7, e il volante Mustang GTD ha finalmente una data",
        readTime: "5 min",
        content: [
          ...
          { kind: "p", text: "**MOZA** è presente al Sim Gaming Expo 2026 (18-20 settembre, al **Renaissance Schaumburg Convention** Center) con il debutto pratico del volante Mustang GTD e un'altra novità assoluta. **At Booth** 515 l'azienda ha mostrato per la prima volta l'**HMA150 Motion System**: una piattaforma di movimento per simulazione domestica costruita attorno a quattro attuatori, ciascuno con 150 mm di corsa e una frequenza di risposta fino a 150 Hz, pilotata dalla telemetria di gioco in tempo reale tramite MOZA Motion Manager per riprodurre accelerazione, frenata, curve ed effetti della superficie del tracciato." },
          { kind: "image", src: "/images/news/moza-gamescom-porsche-ford-mercedes-wheels/15ywfzzzby1mqla-jhk1wh6-8sex6i2jtwpslb7kctnk-4.webp", alt: "Planimetria del Sim Gaming Expo 2026, con MOZA at Booth 515", credit: "MOZA Racing" },
      ...
      pt: {
        ...
        imageAlt: "Os primeiros volantes da MOZA para o PS5 trazem suporte nativo a Gran Turismo 7, e o volante Mustang GTD ganha data",
        readTime: "5 min",
        content: [
          ...
          { kind: "p", text: "A **MOZA** o colocou diante do público em **29 August** (29 de agosto) com um AI vs Human Racing Challenge no estande: o embaixador global da **MOZA**, **Dirk Schouten**, e o tricampeão mundial de F1 Esports **Jarno Opmeer** correram contra o AI Coach, transmitido ao vivo no canal oficial da **MOZA** no YouTube." },
          ...
          { kind: "p", text: "A **MOZA** está na Sim Gaming Expo 2026 (18 a 20 de setembro, no **Renaissance Schaumburg Convention** Center) com a estreia prática do volante Mustang GTD e mais uma novidade. **At Booth** 515, a empresa mostrou pela primeira vez o **HMA150 Motion System**: uma plataforma de movimento para simulação doméstica construída em torno de quatro atuadores, cada um com 150 mm de curso e taxa de resposta de até 150 Hz, controlada por telemetria de jogo em tempo real via MOZA Motion Manager para reproduzir aceleração, frenagem, curvas e efeitos da superfície da pista." },
          { kind: "image", src: "/images/news/moza-gamescom-porsche-ford-mercedes-wheels/15ywfzzzby1mqla-jhk1wh6-8sex6i2jtwpslb7kctnk-4.webp", alt: "Planta baixa da Sim Gaming Expo 2026, mostrando a MOZA at Booth 515", credit: "MOZA Racing" },
