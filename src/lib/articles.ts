...
export const ARTICLES: Article[] = [
  {
    ...
    author: "John Carter",
    sources: [
      { label: "iracing.com", url: "https://www.iracing.com/2026-porsche-esports-supercup-world-championship-series-begins-september-19th/" },
    ],
    content: [
      { kind: "p", text: "Thirty-two drivers. Four regions. Five races left to settle it. The **Porsche** Esports Supercup World Championship Series is back, and it starts September 19th at *Circuit de Spa-Francorchamps*." },
      { kind: "p", text: "Here's the thing: getting to this field was already the hard part. Since late June, the Americas, Middle East & Africa, Europe and Asia-Pacific regions have run their own five-race Regional Championships every other Saturday, each cutting its top eight down from a much bigger pool. Those 32 survivors now move into a five-race Global Championship to crown a single world champion." },
    ...
    translations: {
      de: {
        title: "Porsche Esports Supercup World Championship startet am 19. September",
        excerpt: "Zweiunddreißig Fahrer aus vier Regionen haben sich für die Porsche Esports Supercup World Championship qualifiziert – fünf Rennen von Spa bis Monza, mit 10.000 $ und einem echten Porsche-Renneinsatz als Preis.",
        imageAlt: "Porsche Esports Supercup World Championship startet am 19. September",
        readTime: "2 min",
        content: [
          { kind: "p", text: "Zweiunddreißig Fahrer. Vier Regionen. Fünf Rennen, um es zu entscheiden. Die **Porsche** Esports Supercup World Championship Series ist zurück und startet am 19. September auf dem *Circuit de Spa-Francorchamps*." },
          { kind: "p", text: "Der Punkt ist: Bis in dieses Feld zu kommen, war schon der schwere Teil. Seit Ende Juni haben die Regionen Amerika, Naher Osten & Afrika, Europa und Asien-Pazifik ihre eigenen Regional Championships über fünf Rennen im Zwei-Wochen-Rhythmus samstags ausgetragen und dabei jeweils ihre besten acht aus einem viel größeren Feld herausgefiltert. Diese 32 Überlebenden ziehen jetzt in eine fünf Rennen umfassende Global Championship ein, um einen einzigen Weltmeister zu krönen." },
      ...
      es: {
        title: "El Porsche Esports Supercup World Championship arranca el 19 de septiembre",
        excerpt: "Treinta y dos pilotos de cuatro regiones se han ganado su plaza en el Porsche Esports Supercup World Championship, cinco carreras de Spa a Monza, con 10.000 $ y una plaza real de Porsche en juego.",
        imageAlt: "El Porsche Esports Supercup World Championship arranca el 19 de septiembre",
        readTime: "2 min",
        content: [
          { kind: "p", text: "Treinta y dos pilotos. Cuatro regiones. Cinco carreras para decidirlo. La **Porsche** Esports Supercup World Championship Series está de vuelta, y arranca el 19 de septiembre en el *Circuit de Spa-Francorchamps*." },
          { kind: "p", text: "La cuestión es esta: llegar hasta este grupo ya era la parte difícil. Desde finales de junio, las regiones de Américas, Oriente Medio y África, Europa y Asia-Pacífico han disputado sus propios Regional Championships de cinco carreras cada dos sábados, recortando cada una su top ocho de un grupo mucho mayor. Esos 32 supervivientes pasan ahora a un Global Championship de cinco carreras para coronar a un único campeón del mundo." },
      ...
      fr: {
        title: "Le Porsche Esports Supercup World Championship démarre le 19 septembre",
        excerpt: "Trente-deux pilotes venus de quatre régions ont décroché leur place dans le Porsche Esports Supercup World Championship, cinq courses de Spa à Monza, avec 10 000 $ et un volant Porsche bien réel à la clé.",
        imageAlt: "Le Porsche Esports Supercup World Championship démarre le 19 septembre",
        readTime: "2 min",
        content: [
          { kind: "p", text: "Trente-deux pilotes. Quatre régions. Cinq courses pour trancher. La **Porsche** Esports Supercup World Championship Series est de retour, et ça démarre le 19 septembre sur le *Circuit de Spa-Francorchamps*." },
          { kind: "p", text: "Le fait est que se qualifier pour ce plateau était déjà la partie difficile. Depuis fin juin, les régions Amériques, Moyen-Orient & Afrique, Europe et Asie-Pacifique ont disputé leurs propres Regional Championships de cinq courses, un samedi sur deux, chacune ramenant son top huit d'un bassin bien plus large. Ces 32 survivants passent maintenant à un Global Championship de cinq courses pour couronner un seul champion du monde." },
      ...
      it: {
        title: "La Porsche Esports Supercup World Championship parte il 19 settembre",
        excerpt: "Trentadue piloti di quattro regioni si sono guadagnati un posto nella Porsche Esports Supercup World Championship, cinque gare da Spa a Monza, con 10.000 $ e un volante Porsche vero in palio.",
        imageAlt: "La Porsche Esports Supercup World Championship parte il 19 settembre",
        readTime: "2 min",
        content: [
          { kind: "p", text: "Trentadue piloti. Quattro regioni. Cinque gare per decidere tutto. La **Porsche** Esports Supercup World Championship Series è tornata, e si parte il 19 settembre sul *Circuit de Spa-Francorchamps*." },
          { kind: "p", text: "Il punto è questo: arrivare a questo gruppo era già la parte difficile. Da fine giugno, le regioni Americhe, Medio Oriente e Africa, Europa e Asia-Pacifico hanno corso i propri Regional Championships da cinque gare ogni due sabati, ciascuna riducendo la propria top otto da un gruppo molto più ampio. Questi 32 superstiti passano ora a una Global Championship da cinque gare per incoronare un unico campione del mondo." },
      ...
      pt: {
        title: "Porsche Esports Supercup World Championship começa em 19 de setembro",
        excerpt: "Trinta e dois pilotos de quatro regiões garantiram vaga no Porsche Esports Supercup World Championship, cinco corridas de Spa a Monza, com US$ 10.000 e uma vaga real da Porsche em jogo.",
        imageAlt: "Porsche Esports Supercup World Championship começa em 19 de setembro",
        readTime: "2 min",
        content: [
          { kind: "p", text: "Trinta e dois pilotos. Quatro regiões. Cinco corridas para decidir tudo. A **Porsche** Esports Supercup World Championship Series está de volta, e começa no dia 19 de setembro no *Circuit de Spa-Francorchamps*." },
          { kind: "p", text: "A questão é a seguinte: chegar até esse grupo já era a parte difícil. Desde o final de junho, as regiões Américas, Oriente Médio & África, Europa e Ásia-Pacífico disputaram seus próprios Regional Championships de cinco corridas a cada duas semanas, aos sábados, cada uma reduzindo seu top oito a partir de um grupo muito maior. Esses 32 sobreviventes agora avançam para um Global Championship de cinco corridas para coroar um único campeão mundial." },
          { kind: "h2", text: "Quem passou" },
