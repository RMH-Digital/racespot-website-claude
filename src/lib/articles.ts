...
export const ARTICLES: Article[] = [
  {
    ...
    date: "2026-09-23",
    publishedAt: "2026-09-23T21:35:50Z",
    readTime: "1 min",
    image: "/images/news/thrustmaster-ferrari-499p-centenary-winner-edition/sim-hardware.webp",
    imageAlt: "Illustration representing sim racing hardware news",
    ...
    translations: {
      de: {
        ...
        imageAlt: "Illustration zu Neuigkeiten aus der Sim-Racing-Hardware",
        readTime: "1 min",
        content: [
      ...
      es: {
        ...
        imageAlt: "Ilustración que representa noticias de hardware de sim racing",
        readTime: "2 min",
        content: [
      ...
      fr: {
        ...
        imageAlt: "Illustration représentant l’actualité du matériel de sim racing",
        readTime: "2 min",
        content: [
      ...
      it: {
        ...
        imageAlt: "Illustrazione che rappresenta le notizie sull’hardware per il sim racing",
        readTime: "1 min",
        content: [
      ...
      pt: {
        ...
        imageAlt: "Ilustração representando notícias de hardware de sim racing",
        readTime: "2 min",
        content: [
